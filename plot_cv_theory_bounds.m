...
plot_style = struct( ...
    ...
    'left_axes_position', [0.112 0.300 0.355 0.520], ...
    'right_axes_position', [0.590 0.300 0.340 0.520], ...
...
plot(ax2, cv, 10*log10(islr), '-d', ...
     'LineWidth', 2.2, 'MarkerIndices', marker_idx, ...
     'MarkerSize', 9.4, 'MarkerFaceColor', islr_color, ...
     'Color', islr_color);
grid(ax2, 'on'); box(ax2, 'on');
xlabel(ax2, 'CV', 'FontSize', plot_style.label_font);
ylabel(ax2, 'ISLR (dB)', 'FontSize', plot_style.label_font);
set(ax2.XLabel, 'Units', 'normalized', 'Position', [0.5 -0.125 0]);
set(ax2.YLabel, 'Units', 'normalized', 'Position', [-0.130 0.5 0]);
set(ax2, 'FontSize', plot_style.axes_font, 'XLim', [-0.05 1.05], ...
         'XTick', 0:0.5:1, ...
         'XTickLabel', {'0', '0.5', '1.0'}, ...
         'YLim', [8.78 9.22], ...
         'YTick', 8.8:0.1:9.2, ...
...
draw_pslr_legend(fig, plot_style.legend_position, ...
                 ...
                 plot_style, cfg);
add_panel_caption(fig, ax1, '(a) PSLR bounds', 'YOffset', 0.235, ...
                  'Height', 0.055, 'FontSize', plot_style.panel_caption_font, ...
                  'Interpreter', 'tex');
add_panel_caption(fig, ax2, '(b) Exact ISLR', 'YOffset', 0.235, ...
                  'Height', 0.055, 'FontSize', plot_style.panel_caption_font, ...
                  'Interpreter', 'tex');
tight_export_figure(fig, fullfile(out_dir, 'cv_pslr_islr_theory.pdf'), ...
                    'ContentType', 'image', ...
                    'Resolution', export_resolution, ...
                    'TightPad', 0);
tight_export_figure(fig, fullfile(out_dir, 'cv_pslr_islr_theory.png'), ...
                    'Resolution', export_resolution, ...
                    'TightPad', 0);
end
...
cache_path = fullfile(cache_dir, 'cv_pslr_islr_theory_profile_simulation.mat');
